...
if ($insert) 
{
                ...
                return Redirect()->route('bookcategory.index')->with('success','Catégorie de livre créée avec succès !');
        ...
        if ($update) 
    {
            ...
            return Redirect()->route('bookcategory.index')->with('success','Catégorie de livre Mise à jour réussie !');                     
    }
        else
    {
        $notification=array
...
public function BookDeleteCategory ($id)
    {
        ...
        if ($delete)
                            {
                            $notification=array(
                            'messege'=>'Catégorie de livre supprimée avec succès ',
                            'alert-type'=>'success'
                            );
